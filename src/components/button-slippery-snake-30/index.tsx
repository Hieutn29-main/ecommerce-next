...
interface ButtonSlipperySnake30_I {
  title: string;
  slug: string;
  handleChangeCategory: (slug: string) => void;
}

const ButtonSlipperySnake30 = ({
  title,
  handleChangeCategory,
  slug,
}: ButtonSlipperySnake30_I) => {
...
export default ButtonSlipperySnake30;
